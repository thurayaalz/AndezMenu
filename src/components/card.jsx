...
export default function DrinkCard({ drinkInfo }) {
  return (
    <div className=" flex-col items-center text-center group w-full lg:max-w-[320px] sm:max-w-[190px] md:max-w-[280px] p-4  rounded-[0.2rem] border border-gray-15 shadow-sm hover:shadow-md transition-shadow duration-300">
      {/* 1- مكون الصورة */}
